...
almanah_search_dialog_new (void)
{
	...
	priv = almanah_search_dialog_get_instance_private(ALMANAH_SEARCH_DIALOG (search_dialog));
...
{
	AlmanahSearchDialogPrivate *priv = almanah_search_dialog_get_instance_private(ALMANAH_SEARCH_DIALOG (*search_dialog_weak_pointer));
	GDate date;
